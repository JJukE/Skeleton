...
class Train(object):
    def __init__(self, cfg):
        ...
        cfg.info("Data save path: {}".format(os.getcwd()))
    ...
    def train_epoch(self, epoch, stage):
        ...
        phase = "train"
        self.cfg.info("-" * 100)
        self.cfg.info("Switch phase to {}.".format(phase))
        self.cfg.info("-" * 100)
...
# TODO: make sure that the train dataset and the validation dataaset have the same number of object categories